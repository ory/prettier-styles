...
_Please note_: We take Ory Prettier Styles's security and our users' trust very seriously. If you believe you have found a security issue
in Ory Prettier Styles, please responsibly disclose by contacting us at security@ory.sh.
...
do this is via
[Ory Prettier Styles Discussions](https://github.com/orgs/ory/discussions) or the
...
- **Helping with open issues.** We have a lot of open issues for Ory Prettier Styles and some of them may lack necessary information,
...
Check out [Ory Prettier Styles Discussions](https://github.com/orgs/ory/discussions). This is a great place for in-depth discussions and lots of code examples, logs
and similar data.
...
If you want to receive regular notifications about updates to Ory Prettier Styles, consider joining the mailing list. We will _only_ send
...
[in our chat](https://www.ory.sh/chat) before getting started to ensure your work is consistent with Ory Prettier Styles's roadmap and
architecture.
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform commit history and helps structure the changelog.  
   Please refer to this [list of prefixes for Prettier Styles](https://github.com/ory/prettier-styles/blob/master/.github/semantic.yml) for an
   overview.
...
[docs](https://github.com/ory/prettier-styles/tree/master/docs) folder. Generate API and configuration reference documentation using
`cd docs; npm run gen`.
