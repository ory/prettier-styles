...
# Contribute to Ory Prettier Styles<!-- omit in toc -->
...
Styles, please disclose it by contacting us at security@ory.sh.
...
won't clash with Ory Prettier Styles's direction. A great way to do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Prettier
